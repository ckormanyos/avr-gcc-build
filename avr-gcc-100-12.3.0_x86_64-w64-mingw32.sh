...
rm -rf /d/a/avr-gcc-build/avr-gcc-build | true


echo 'make and enter gcc_build directory'
mkdir -p /d/a/avr-gcc-build/avr-gcc-build/gcc_build


echo 'copy gcc 12.3.0 patch file'
cd /d/a/avr-gcc-build/avr-gcc-build/gcc_build
cp ../avr-gcc-100-12.3.0_x86_64-w64-mingw32.patch .


echo 'append standalone gcc-x86_64-w64-mingw32 path'
export X_DISTRO_ROOT=/d/a/avr-gcc-build/avr-gcc-build/mingw
...
cmake "-DCMAKE_BUILD_TYPE=Release" "-DCMAKE_C_FLAGS=-s -O3" "-DCMAKE_INSTALL_PREFIX=/d/a/avr-gcc-build/avr-gcc-build/local/zstd-1.5.5" "-DZSTD_BUILD_SHARED=OFF" -G Ninja /d/a/avr-gcc-build/avr-gcc-build/gcc_build/zstd-1.5.5/build/cmake
ninja
ninja install
...
../libiconv-1.17/configure --prefix=/d/a/avr-gcc-build/avr-gcc-build/local/libiconv-1.17 --build=x86_64-w64-mingw32 --target=x86_64-w64-mingw32 --host=x86_64-w64-mingw32 --enable-static --disable-shared
make --jobs=6
make install
...
cd objdir-gmp-6.3.0
../gmp-6.3.0/configure --prefix=/d/a/avr-gcc-build/avr-gcc-build/local/gmp-6.3.0 --build=x86_64-w64-mingw32 --target=x86_64-w64-mingw32 --host=x86_64-w64-mingw32 --enable-static --disable-shared
make --jobs=`nproc`
make install
...
../mpfr-4.2.1/configure --prefix=/d/a/avr-gcc-build/avr-gcc-build/local/mpfr-4.2.1 --build=x86_64-w64-mingw32 --target=x86_64-w64-mingw32 --host=x86_64-w64-mingw32 --enable-static --disable-shared --with-gmp=/d/a/avr-gcc-build/avr-gcc-build/local/gmp-6.3.0
make --jobs=6
make install
...
cd objdir-mpc-1.3.1
../mpc-1.3.1/configure --prefix=/d/a/avr-gcc-build/avr-gcc-build/local/mpc-1.3.1 --build=x86_64-w64-mingw32 --target=x86_64-w64-mingw32 --host=x86_64-w64-mingw32 --enable-static --disable-shared --with-gmp=/d/a/avr-gcc-build/avr-gcc-build/local/gmp-6.3.0 --with-mpfr=/d/a/avr-gcc-build/avr-gcc-build/local/mpfr-4.2.1
make --jobs=`nproc`
make install
...
cd objdir-isl-0.15
../isl-0.15/configure --prefix=/d/a/avr-gcc-build/avr-gcc-build/local/isl-0.15 --build=x86_64-w64-mingw32 --target=x86_64-w64-mingw32 --host=x86_64-w64-mingw32 --enable-static --disable-shared --with-gmp-prefix=/d/a/avr-gcc-build/avr-gcc-build/local/gmp-6.3.0
make --jobs=`nproc`
make install
...
../cloog-0.18.1/configure --prefix=/d/a/avr-gcc-build/avr-gcc-build/local/cloog-0.18.1 --build=x86_64-w64-mingw32 --target=x86_64-w64-mingw32 --host=x86_64-w64-mingw32 --enable-static --disable-shared --with-isl=/d/a/avr-gcc-build/avr-gcc-build/local/isl-0.15 --with-gmp=/d/a/avr-gcc-build/avr-gcc-build/local/gmp-6.3.0
make --jobs=6
make install
...
../binutils-2.41/configure --prefix=/d/a/avr-gcc-build/avr-gcc-build/local/gcc-12.3.0-avr --target=avr --enable-languages=c,c++ --build=x86_64-w64-mingw32 --host=x86_64-w64-mingw32 --with-pkgversion='Built by ckormanyos/real-time-cpp' --enable-static --disable-shared --disable-libada --disable-libssp --disable-nls --enable-mingw-wildcard --with-gnu-as --with-dwarf2 --with-isl=/d/a/avr-gcc-build/avr-gcc-build/local/isl-0.15 --with-cloog=/d/a/avr-gcc-build/avr-gcc-build/local/cloog-0.18.1 --with-gmp=/d/a/avr-gcc-build/avr-gcc-build/local/gmp-6.3.0 --with-mpfr=/d/a/avr-gcc-build/avr-gcc-build/local/mpfr-4.2.1 --with-mpc=/d/a/avr-gcc-build/avr-gcc-build/local/mpc-1.3.1 --with-libiconv-prefix=/d/a/avr-gcc-build/avr-gcc-build/local/libiconv-1.17 --with-zstd=/d/a/avr-gcc-build/avr-gcc-build/local/zstd-1.5.5/lib --disable-werror
make --jobs=`nproc`
make install
...
../gcc-12.3.0/configure --prefix=/d/a/avr-gcc-build/avr-gcc-build/local/gcc-12.3.0-avr --target=avr --enable-languages=c,c++ --build=x86_64-w64-mingw32 --host=x86_64-w64-mingw32 --with-pkgversion='Built by ckormanyos/real-time-cpp' --enable-static --disable-shared --disable-libada --disable-libssp --disable-nls --enable-mingw-wildcard --with-gnu-as --with-dwarf2 --with-isl=/d/a/avr-gcc-build/avr-gcc-build/local/isl-0.15 --with-cloog=/d/a/avr-gcc-build/avr-gcc-build/local/cloog-0.18.1 --with-gmp=/d/a/avr-gcc-build/avr-gcc-build/local/gmp-6.3.0 --with-mpfr=/d/a/avr-gcc-build/avr-gcc-build/local/mpfr-4.2.1 --with-mpc=/d/a/avr-gcc-build/avr-gcc-build/local/mpc-1.3.1 --with-libiconv-prefix=/d/a/avr-gcc-build/avr-gcc-build/local/libiconv-1.17 --with-zstd=/d/a/avr-gcc-build/avr-gcc-build/local/zstd-1.5.5/lib
make --jobs=`nproc`
make install


ls -la /d/a/avr-gcc-build/avr-gcc-build/local/gcc-12.3.0-avr/bin /d/a/avr-gcc-build/avr-gcc-build/local/gcc-12.3.0-avr/bin/avr-gcc* /d/a/avr-gcc-build/avr-gcc-build/local/gcc-12.3.0-avr/bin/avr-g++*
