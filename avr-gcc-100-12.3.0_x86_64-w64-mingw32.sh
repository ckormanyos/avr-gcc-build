...
cmake "-DCMAKE_BUILD_TYPE=Release" "-DCMAKE_C_FLAGS=-s -O3" "-DCMAKE_INSTALL_PREFIX=../local/zstd-1.5.5" "-DZSTD_BUILD_SHARED=OFF" -G Ninja "$SCRIPT_DIR"/gcc_build/zstd-1.5.5/build/cmake
ninja
ninja install
