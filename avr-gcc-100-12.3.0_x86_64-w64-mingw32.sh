...
../mpfr-4.2.1/configure --prefix=/home/runner/work/avr-gcc-build/avr-gcc-build/local/mpfr-4.2.1 --build=$BUILD_NAME --target=$HOST_NAME --host=$HOST_NAME --enable-static --disable-shared --with-gmp=/home/runner/work/avr-gcc-build/avr-gcc-build/local/gmp-6.3.0
make --jobs=6
make install
...
cd objdir-mpc-1.3.1
../mpc-1.3.1/configure --prefix=/home/runner/work/avr-gcc-build/avr-gcc-build/local/mpc-1.3.1 --build=$BUILD_NAME --target=$HOST_NAME --host=$HOST_NAME --enable-static --disable-shared --with-gmp=/home/runner/work/avr-gcc-build/avr-gcc-build/local/gmp-6.3.0 --with-mpfr=/home/runner/work/avr-gcc-build/avr-gcc-build/local/mpfr-4.2.1
make --jobs=6
make install
...
#PATH=/home/runner/work/avr-gcc-build/avr-gcc-build/local/gcc-12.3.0-avr/bin:"$PATH"
#export PATH
#CC=""
#export CC
#
